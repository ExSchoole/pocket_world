function build(classOfEmptyElement, building, position, playerName, info, type) {
    var typeOfSelectedBuilding = $(building).attr("id");
    var selectedPosition = $(position).attr("id");

    $.ajax({
        type: 'POST',
        url: DICTIONARY.urls.addBuilding,
        ...
        success: function (data, textStatus) {
            ...
            timer(selectedPosition, info[k].time * 1000, playerName, type);
        }
    });
};